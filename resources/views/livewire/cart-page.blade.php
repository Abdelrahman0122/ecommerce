                                ...
                                <tr wire:key='{{ $item['product_id'] }}'>
                                    ...
                                    <td><button wire:click="removeFromCart({{ $item['product_id'] }})"
                                            ...
                                            <span wire:loading.remove
                                                wire:target= 'removeFromCart({{ $item['product_id'] }})'>Remove</span><span
                                                wire:loading
                                                wire:target= 'removeFromCart({{ $item['product_id'] }})'>Removing...</span></button>
                                    </td>
                                </tr>
                            @empty
                                <tr>
            ...
            <div class="md:w-1/4">
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="flex justify-between mb-2">
                        <span>Subtotal</span>
                        <span>{{ Number::currency($total, 'EGP') }}</span>
                    </div>
                    <div class="flex justify-between mb-2">
                        <span>Taxes</span>
                    ...
                    <div class="flex justify-between mb-2">
                        ...
                        <span class="font-semibold">{{ Number::currency($total, 'EGP') }}</span>
                    </div>
                    @if ($cart_items)
